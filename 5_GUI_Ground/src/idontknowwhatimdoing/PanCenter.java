...
public class PanCenter extends JPanel implements ActionListener, KeyListener{
    ...
    ImageIcon iiback = new ImageIcon(this.getClass().getResource("Boston CityScape.png"));
    ...
    public void paint(Graphics g) {
        ...
        //int nWid = Rect2.
        Shape Rect = new Rectangle2D.Double(x, y+440, 600, 900);//Ground
    ...
    //class Event implements ActionListener, KeyListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Shape Rect = new Rectangle2D.Double(x, y+440, 600, 900);
            //int i = 0;
            if (Rect.intersects((Rectangle2D) Rect2)){
                i+=1;
                System.out.println("fuckyouman" +i);
